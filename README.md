...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,338 | 🐛 106 | 📅 2026-09-02.
...
* [Unix history](https://github.com/dspinellis/unix-history-repo) ⭐ 7,267 | 🐛 0 | 🌐 Assembly | 📅 2026-01-05 - Git repository with 46 years of Unix history evolution.
...
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 512 | 🐛 12 | 🌐 Java | 📅 2026-09-23 - Library/API for detection of refactorings in changes of Java code.
