...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,087 | 🐛 106 | 📅 2026-09-02.
...
* [Unix history](https://github.com/dspinellis/unix-history-repo) ⭐ 7,259 | 🐛 0 | 🌐 Assembly | 📅 2026-01-05 - Git repository with 46 years of Unix history evolution.
* [Defects4J](https://github.com/rjust/defects4j) ⭐ 997 | 🐛 57 | 🌐 Perl | 📅 2026-04-07 - Collection of 395 reproducible bugs collected with the goal of advancing software testing research.
* [Linux Kernel 4.21 Call Graphs](https://zenodo.org/record/2652487#.XRnvomUzb0o) - The Linux Kernel 4.21 Call Graphs produced using [CScout](https://github.com/dspinellis/cscout/) ⭐ 235 | 🐛 15 | 🌐 C++ | 📅 2026-09-05.
...
* [PyDriller](https://github.com/ishepard/pydriller) ⭐ 966 | 🐛 10 | 🌐 Python | 📅 2026-09-11 - Python Framework to analyse Git repositories.
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 511 | 🐛 27 | 🌐 Java | 📅 2026-09-10 - Library/API for detection of refactorings in changes of Java code.
