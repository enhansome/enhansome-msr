...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,059 | 🐛 100 | 📅 2026-06-30.
...
* [Linux Kernel 4.21 Call Graphs](https://zenodo.org/record/2652487#.XRnvomUzb0o) - The Linux Kernel 4.21 Call Graphs produced using [CScout](https://github.com/dspinellis/cscout/) ⭐ 232 | 🐛 12 | 🌐 C++ | 📅 2026-08-10.
...
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 503 | 🐛 28 | 🌐 Java | 📅 2026-08-12 - Library/API for detection of refactorings in changes of Java code.
