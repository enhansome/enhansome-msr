...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 500,096 | 🐛 105 | 📅 2026-08-21.
...
* [Unix history](https://github.com/dspinellis/unix-history-repo) ⭐ 7,250 | 🐛 0 | 🌐 Assembly | 📅 2026-01-05 - Git repository with 46 years of Unix history evolution.
...
* [Linux Kernel 4.21 Call Graphs](https://zenodo.org/record/2652487#.XRnvomUzb0o) - The Linux Kernel 4.21 Call Graphs produced using [CScout](https://github.com/dspinellis/cscout/) ⭐ 232 | 🐛 12 | 🌐 C++ | 📅 2026-08-26.
...
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 504 | 🐛 26 | 🌐 Java | 📅 2026-08-26 - Library/API for detection of refactorings in changes of Java code.
