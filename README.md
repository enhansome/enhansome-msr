...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,975 | 🐛 105 | 📅 2026-08-21.
...
* [Unix history](https://github.com/dspinellis/unix-history-repo) ⭐ 7,252 | 🐛 0 | 🌐 Assembly | 📅 2026-01-05 - Git repository with 46 years of Unix history evolution.
...
* [Linux Kernel 4.21 Call Graphs](https://zenodo.org/record/2652487#.XRnvomUzb0o) - The Linux Kernel 4.21 Call Graphs produced using [CScout](https://github.com/dspinellis/cscout/) ⭐ 234 | 🐛 14 | 🌐 C++ | 📅 2026-08-27.
...
* [PyDriller](https://github.com/ishepard/pydriller) ⭐ 966 | 🐛 12 | 🌐 Python | 📅 2026-07-26 - Python Framework to analyse Git repositories.
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 504 | 🐛 25 | 🌐 Java | 📅 2026-09-01 - Library/API for detection of refactorings in changes of Java code.
