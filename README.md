# Awesome Empirical Software Engineering with stars
...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 500,891 | 🐛 105 | 📅 2026-08-21.
...
* [ESEUR](https://github.com/Derek-Jones/ESEUR-code-data) ⭐ 423 | 🐛 3 | 🌐 R | 📅 2026-06-17 All data used in the openly available book [Evidence-based Software Engineering](http://www.knosof.co.uk/ESEUR/index.html)
...
* [Unix history](https://github.com/dspinellis/unix-history-repo) ⭐ 7,251 | 🐛 0 | 🌐 Assembly | 📅 2026-01-05 - Git repository with 46 years of Unix history evolution.
* [Defects4J](https://github.com/rjust/defects4j) ⭐ 994 | 🐛 56 | 🌐 Perl | 📅 2026-04-07 - Collection of 395 reproducible bugs collected with the goal of advancing software testing research.
* [Linux Kernel 4.21 Call Graphs](https://zenodo.org/record/2652487#.XRnvomUzb0o) - The Linux Kernel 4.21 Call Graphs produced using [CScout](https://github.com/dspinellis/cscout/) ⭐ 233 | 🐛 12 | 🌐 C++ | 📅 2026-08-27.
...
* [npm-miner](https://github.com/AuthEceSoftEng/msr-2018-npm-miner) ⭐ 1 | 🐛 1 | 🌐 JavaScript | 📅 2020-04-21 - The dataset contains the analysis results of 5 open source software quality tools eslint, escomplex, nsp, jsinspect and sonarjs for 2000 popular (in terms of stars and downloads) npm packages.
* [Maven metrics](https://github.com/bkarak/data_msr2015) ⭐ 0 | 🐛 1 | 🌐 TeX | 📅 2015-05-16 - Collection of software complexity & sizing metrics for the [Maven Repository](https://maven.apache.org).
...
* [PyDriller](https://github.com/ishepard/pydriller) ⭐ 965 | 🐛 12 | 🌐 Python | 📅 2026-07-26 - Python Framework to analyse Git repositories.
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 504 | 🐛 25 | 🌐 Java | 📅 2026-08-29 - Library/API for detection of refactorings in changes of Java code.
* [Perceval](https://github.com/chaoss/grimoirelab-perceval) ⭐ 324 | 🐛 41 | 🌐 Python | 📅 2026-08-07 - Fetch repository data from tens of back-ends.
...
* [DesigniteJava](https://github.com/tushartushar/DesigniteJava) ⭐ 194 | 🐛 18 | 🌐 Java | 📅 2025-03-21 - Compute source code metrics and detect a variety of implementation and design smells for Java.
* [reaper](https://github.com/RepoReapers/reaper) ⭐ 118 | 🐛 6 | 🌐 Python | 📅 2020-09-27 - Python tool to compute a score for a repository from GHTorrent. The score quantifies the extent to which the project contained within the repository is *engineered*.
* [Coming](https://github.com/SpoonLabs/coming/) ⭐ 102 | 🐛 27 | 🌐 Java | 📅 2024-11-13 - A Java framework for analyzing code changes and mining instances of change patterns from Git repositories.
* [qmcalc](https://github.com/dspinellis/cqmetrics) ⭐ 69 | 🐛 4 | 🌐 C++ | 📅 2022-06-14 - Calculate quality metrics from C source code.
* [VulData7](https://github.com/electricalwind/data7) ⭐ 45 | 🐛 4 | 🌐 Java | 📅 2019-01-11 - Java framework enabling the automated collection of commits fixing vulnerabilities that are reported in NVD (links NVD with Git).
* [Puppeteer](https://github.com/tushartushar/Puppeteer) ⭐ 41 | 🐛 0 | 🌐 Python | 📅 2020-09-26 - Detect configuration smells in Puppet code.
* [Maven-miner](https://github.com/diverse-project/maven-miner) ⭐ 34 | 🐛 14 | 🌐 Java | 📅 2022-09-01 - Java tools and infrastructure to resolve the whole Maven dependency graph, hosted in Maven Central, in the form of a [Neo4j](https://neo4j.com/) Graph.
...
* [GitEvo](https://github.com/andrehora/gitevo) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2025-11-16 - Code evolution analysis for Git repositories.
* [DbDeo](https://github.com/tushartushar/DbDeo) ⭐ 13 | 🐛 0 | 🌐 Python | 📅 2018-01-24 - Extract embedded SQL statements and detect database schema smells.
* [CryptOSS](https://github.com/rvantonder/CryptOSS) ⭐ 7 | 🐛 2 | 🌐 OCaml | 📅 2019-07-04 - Mine GitHub activity and market cap data for cryptocurrency projects.
